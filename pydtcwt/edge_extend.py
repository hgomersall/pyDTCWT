...
def symmetrically_extend(input_array, extension_length, axis=-1):
    ...
    if extension_length <= input_length:
        extension_source = input_array[input_reverser]
    else:
    ...
    output_array[post_slicer] = extension_source[pre_slicer]
    output_array[pre_slicer] = extension_source[post_slicer]
    output_array[main_slicer] = input_array
